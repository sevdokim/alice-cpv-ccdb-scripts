...
o2::phos::Pedestals* readPHSPedestalsFromCCDB_v2(const char* ccdbURI = "localhost:8084", long timeStamp = 0, bool isHG = 1)
{
  ...
  TFile *file = TFile::Open("PHS_pedestals.root","recreate");
